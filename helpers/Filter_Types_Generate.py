...
def export_to_json(eng_to_flang):
    ...
    dump_dict(eng_to_flang, 'filter_types.json')    
...
def main():
    ...
    file_meta = { 'gid' : 0, 'eng1' : 1, 'eng2':2, 'spa1':4, 'spa2':5, 'spa3':6}
    file_info = { 'path':'./Batch2_ES_SP.xlsx', 'sheet_name': 'Filters', meta_s : file_meta}
